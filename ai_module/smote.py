...
def balance_training_data_smote(
    X: pd.DataFrame,
    y: pd.Series,
    *,
    ...
    """Balance the training fold with standard SMOTE synthetic samples."""
    ...
    if minority_count < 2:
        return X.copy(), y.copy(), {
            "strategy": "none_minority_too_small_for_smote",
...
__all__ = ["balance_training_data_smote"]
