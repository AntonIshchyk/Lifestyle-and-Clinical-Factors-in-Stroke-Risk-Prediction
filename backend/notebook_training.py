...
FINAL_MODEL_CONFIGS = [
    {
        ...
        "selectionReason": "Best F1/precision-recall balance for Random Forest among rows with 20k-30k false positives.",
        "algorithm": "random_forest",
        "classificationThreshold": 0.5,
        "hyperparameters": {"max_depth": 12, "min_samples_leaf": 2, "n_estimators": 100},
        "sourceModelId": "random_forest_weighted_combined_with_uncertain__tuned_auto_cd33472f08",
        "sourceMetrics": {"falseNegatives": 1091, "falsePositives": 21004},
    },
    {
        "profile": "low_false_negative",
        "selectionReason": "Lowest false-negative count for Random Forest; tied rows use the simplest leaf setting.",
        "algorithm": "random_forest",
        "classificationThreshold": 0.4,
        "hyperparameters": {"max_depth": 3, "min_samples_leaf": 1, "n_estimators": 300},
        "sourceModelId": "random_forest_weighted_combined_with_uncertain__tuned_auto_7a4e2728d4",
        "sourceMetrics": {"falseNegatives": 330, "falsePositives": 42420},
    },
    {
        "profile": "best_balance",
        "selectionReason": "Best F1/precision-recall balance for LightGBM among rows with 20k-30k false positives.",
        "algorithm": "lightgbm",
        "classificationThreshold": 0.5,
        "hyperparameters": {"learning_rate": 0.1, "max_depth": 20, "n_estimators": 200, "num_leaves": 63},
        "sourceModelId": "lightgbm_weighted_combined_with_uncertain__tuned_auto_8e5a21c792",
        "sourceMetrics": {"falseNegatives": 1163, "falsePositives": 20207},
    },
    {
        "profile": "low_false_negative",
        "selectionReason": "Lowest false-negative count for LightGBM; this is the same configuration as the best-balance LightGBM row.",
        "algorithm": "lightgbm",
        "classificationThreshold": 0.4,
        ...
        "sourceMetrics": {"falseNegatives": 553, "falsePositives": 32261},
    },
    {
        "profile": "best_balance",
        "selectionReason": "Best F1/precision-recall balance for XGBoost among rows with 20k-30k false positives.",
        "algorithm": "xgboost",
        "classificationThreshold": 0.5,
        "hyperparameters": {"learning_rate": 0.1, "max_depth": 6, "n_estimators": 300, "subsample": 1.0},
        "sourceModelId": "xgboost_weighted_combined_with_uncertain__tuned_auto_0703ed6edb",
        "sourceMetrics": {"falseNegatives": 1178, "falsePositives": 20112},
    },
    {
        "profile": "low_false_negative",
        "selectionReason": "Lowest false-negative count for XGBoost.",
        "algorithm": "xgboost",
        "classificationThreshold": 0.4,
        "hyperparameters": {"learning_rate": 0.05, "max_depth": 3, "n_estimators": 100, "subsample": 1.0},
        "sourceModelId": "xgboost_weighted_combined_with_uncertain__tuned_auto_7748123ba7",
        "sourceMetrics": {"falseNegatives": 519, "falsePositives": 33902},
    },
]
